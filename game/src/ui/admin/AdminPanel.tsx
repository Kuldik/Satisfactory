...
// from kenney_building-kit parts.
...
const KIT_MODEL_BASE = '/kits/kenney_building-kit/Models/GLB format';
const KIT_PREVIEW_BASE = '/kits/kenney_building-kit/Previews';
...
export const AdminPanel: FC<AdminPanelProps> = ({
  ...
  const handleImport = useCallback(async () => {
    ...
    setImportInfo(count > 0 ? `Импортировано: ${count}` : 'Не удалось импортировать');
      ...
      <div className="admin-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="admin-body">
          ...
          <div className="admin-composition">
            ...
            <div className="admin-comp-stat">
              Режим: <strong>{builderMode === 'single' ? 'Обычный' : 'ВЖУХ'}</strong>
            </div>
            <div className="admin-comp-stat">
            ...
            <div className="admin-btn-row">
              ...
              <button className="admin-btn" onClick={() => onSetBuilderMode('line')}>ВЖУХ</button>
            </div>
            ...
            <div className="admin-comp-hint">
              После размещения всех деталей нажмите<br />
              «Сгенерировать JSON» — скопируйте и<br />
              вставьте в код как новое строение.
            </div>

            <button className="admin-btn admin-btn-export" onClick={handleExport} disabled={placedCount === 0}>
              📄 Сгенерировать JSON
            </button>
